...
export const SHUIHU_PROPS: PropPlacement[] = [
  // 酒旗：主角与枯树之间、贴幕前——影小而锐，旗面字看得清（左侧是老虎常驻位，会被挡）
  { name: 'jiuqi', x: 0.36, z: 0.1, height: 0.85 },
  // 山石：右后景、近灯——影大而虚，当景阳冈远山
  { name: 'shanshi', x: 0.62, z: 0.6, height: 0.8 },
];
...
export const XIYOU_PROPS: PropPlacement[] = [
  ...
  // 山石复用：左侧景，靠灯拉开前后层次
  { name: 'shanshi', x: -0.7, z: 0.55, height: 0.7 },
];
